...
Usage:
    ...
    >>> index = build_faiss_index(chunks, save_dir="data/faiss_index")
    >>> index, metadata = load_faiss_index("data/faiss_index")
"""
...
def get_index_paths(save_dir: str = "data/faiss_index") -> Tuple[str, str]:
...
def has_faiss_index(save_dir: str = "data/faiss_index") -> bool:
